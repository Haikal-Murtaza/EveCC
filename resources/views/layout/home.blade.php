...
{{-- Awal Carousel --}}
<div id="myCarousel" class="carousel slide carousel-fade mt-5" data-bs-ride="carousel">
...
<div class="container text-center my-5 pt-5">
    ...
    <p class="desc mt-5">
        ...
        accumsan fringilla, tellus tellus tincidunt diam, eleifend commodo ipsum nibh sed est. Mauris id metus
        finibus, scelerisque risus quis, eleifend urna. Curabitur tortor augue, maximus eu pulvinar sed, convallis
